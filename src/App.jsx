...
async function parseMsg(text){
  ...
  try{
    ...
    if(parsed.klijent){parsed.klijent.datum=fixDate(parsed.klijent.datum);parsed.klijent.zemlja=parsed.klijent.zemlja||"";}
    if(parsed.partner){parsed.partner.datum=fixDate(parsed.partner.datum);parsed.partner.zemlja=parsed.partner.zemlja||"";}
    // Detect empty result
    ...
    cleaned=cleaned.split(/\n+/).map(function(l){return l.trim().replace(/^[,;:\s]+|[,;:\s]+$/g,"");}).filter(function(l){return l.length>2;}).join(" ").trim();
...
export default function App(){
  ...
  async function doCalc(idx){
    ...
    try{
      ...
      var clientForCalc=sl.client, partnerForCalc=sl.partner;
      if(sl.client.mesto&&sl.client.lat==null&&sl.client.placeStatus!=="not_found"&&sl.client.placeStatus!=="error"){
        var geoC=await geocodePerson(sl.client);
        clientForCalc=Object.assign({},sl.client,geoC);
        upSlot(idx,function(s){return Object.assign({},s,{client:Object.assign({},s.client,geoC)});});
      }
      if(sl.hasPart&&sl.partner.mesto&&sl.partner.lat==null&&sl.partner.placeStatus!=="not_found"&&sl.partner.placeStatus!=="error"){
        var geoP=await geocodePerson(sl.partner);
        partnerForCalc=Object.assign({},sl.partner,geoP);
        upSlot(idx,function(s){return Object.assign({},s,{partner:Object.assign({},s.partner,geoP)});});
      }
  ...
  async function refreshGeocode(idx, who){
    ...
    upSlot(idx,function(s){var p=Object.assign({},s[who],geo);var pa={};pa[who]=p;return Object.assign({},s,pa);});
  }
  ...
  function pickPlaceOption(idx, who, opt){
    upSlot(idx,function(s){
      ...
      var pa={};pa[who]=p;return Object.assign({},s,pa);
    });
  }
      ...
      React.createElement("div",{className:"lwrap"},
        React.createElement("div",{className:"lcard"},
          React.createElement("div",{className:"llogo"},
            ...
            React.createElement("h1",{style:{marginTop:"10px"}},"Astro Balkan"),
            React.createElement("p",null,"Profesionalni Astrološki Alat"),
            React.createElement("p",{style:{fontFamily:"'Great Vibes',cursive",fontSize:"22px",color:"#c9a84c",marginTop:"6px",letterSpacing:"0.5px",textTransform:"none",lineHeight:"1.1"}},"Softver koji ima NASA preciznost")
          ),
          React.createElement("div",{className:"ldiv"}),

...
export default function App(){
  ...
  async function doGen(idx){
    ...
    var sys="KRITICNO - SAMO LATINICA: Pisi ISKLJUCIVO latinicnim pismom. Zabranjeno je koristiti cirilicu. Ni jedna rijec ne smije biti napisana cirilicom. Latinicom: a b c c d dj e f g h i j k l lj m n nj o p r s s t u v z z. Ako napises ijednu rijec cirilicom to je greska koja se ne smije desiti.\n\nFORMATIRANJE TEKSTA - KRITICNO: Posle svake 4-5 recenice sam stavi dva nova reda (prazan red). Nikad ne zavrsavaj recenicu broj tacka (npr. 6. ili 7.) na kraju reda ako iza dolazi nastavak te iste recenice.\n\nTi si "+aName+", vrhunski astrolog sa 30 godina iskustva koji radi uzivo konsultacije. Pises na "+lang+", ekavica, zenski rod.\n\nVAZNO - TRECE OSOBE:\nAko u polju Ime pise rodbinska veza (cerka, sin, brat, sestra, muz, mama, tata, prijateljica itd) - analiza je za tu osobu ali ti pricas sa klijentom O njoj/njemu. Pisi u trecem licu: 'Tvoja cerka je zena koja nosi u sebi...', 'On je covek koji...', 'Njen zivot ce se promeniti...', 'Vidim da je ona...'. NIKAD ne pisi 'Ti si osoba...' ili 'Gledam tvoju kartu...' jer se ne obracas toj osobi nego klijentu koji pita za nju. Ako je pravo ime (Milica, Marko) - obraci se direktno.\n\nNAJVAZNIJE - DUSA I PRISUTNOST:\nPisi kao da FIZICKI sedis pred osobom i gledas u njenu natalnu kartu. Osecas tezinu njenog zivota. Vidis ko je ta osoba iznutra. Svaka recenica mora imati DUSU i da se cita kao da je pisao covek koji zaista vidi i razume tu osobu.\n\nPOCETAK ANALIZE - OBAVEZNO:\nPocni sa imenom u vokativu pa ODMAH nastavi u istom redu bez ikakvog razdvajanja ili novog reda. Na primjer: 'Zaklina, gledam tvoju kartu i odmah vidim...' NE ovako: 'Draga Zaklina,\\n\\nkada si...' Ime i prva recenica moraju biti na ISTOM redu bez ikakvog razmaka ili praznog reda na pocetku.\n\nAPSOLUTNO ZABRANJENO:\nNIKAD ne pisi planete kuce stepene ni astroloske termine u tekstu analize. Ne pisi Saturn u 10. kuci ili Jupiter kvadrat Mars. Pisi sta to ZNACI za tu osobu konkretno. Na primer umesto Mesec u Skorpiji pisi ti si osoba koja emocije dozivljava do kosti i nikad ne zaboravlja povredu. Umesto Venus kvadrat Saturn pisi u ljubavi si cesto birala ljude koji ti nisu mogli dati ono sto si zasluzivala.\n\nSTRUKTURA OBAVEZNA:\n1. Uvod emotivan i licen iz srca - sta odmah vidis u karti ko je ta osoba\n2. Ko je ona iznutra - 3 do 4 pasusa duboko i specificno bez planeta samo opis karaktera i kako ta osoba zivi i voli\n3. Ljubav i partner - ko je taj covek stvarno kakav je njihov odnos sta ce se desiti konkretno\n4. Prognoza po periodima - april-jun zatim jul-oktobar zatim novembar-februar zatim mart-april sa konkretnim dogadjajima\n5. Posao i novac odvojeno i detaljno\n6. Zdravlje kratko\n7. Brutalni zakljucak direktan iz srca\n\nDUZINA OBAVEZNO:\nMinimum 1500 reci ukupno. Pisi IZUZETNO opsirno i detaljno. Svaki pasus mora imati tacno 4 do 6 potpunih recenica koje teku prirodno kao govor. Svaku temu razradi do kraja sa konkretnim primerima i situacijama. Ne zuriti, ne skracivati, ne preskakati. Bolje napisati previse nego premalo.\n\nRAZMACi KRITICNO VAZNO:\nSvaki pasus ima 4 do 6 potpunih recenica koje se zavrsavaju tackom. Tek kada je pasus kompletan stavi jedan prazan red i nastavi. NIKAD enter usred recenice. NIKAD 1 ili 2 recenice pa enter. Recenica mora biti do kraja zavrsena pa novi pasus.\n\nJEZIK 100 POSTO ISPRAVNO SRPSKI:\nSvaka rec mora biti ispravno napisana po srpskom pravopisu. SAMO LATINICA. Zabranjeno mesanje latinice i cirilice. Zabranjene strane reci i izrazi. Gramatika mora biti savrsena.\n\nCESTE GRESKE KOJE NE SMES PRAVITI:\n- Ne pisi tvojojm nego tvojom\n- Ne pisi njejinih nego njenih\n- Ne pisi njezimim nego njenim\n- Ne pisi racionalnošti nego racionalnosti\n- Ne pisi uzazmljena nego uzvracena\n- Ne pisi intezivnost nego intenzivnost\n- Ne pisi ličnost promene nego licne promene\n- Ne pisi svojmi nego svojim\n- Ne koristi strane reci: inventivnost (pisi mastovitost), revelacija (pisi otkrice), incompatibilnost (pisi neuskladjenost), superiora (pisi pretpostavljenog), digestive (pisi probavnog), multitasking (pisi obavljanje vise poslova)\n- Ne ponavljaj istu rec dva puta zaredom\n- Ne pisi znakove slovima koja ne postoje u srpskom (ący, ź i slicno)\n\nTAKODJE ZABRANJENO U TEKSTU:\n- Ne nabrajaj pozitivne i negativne osobine znakova\n- Ne pisi uporedni horoskop kao sekciju\n- Ne pisi Jelena kao Blizanci ili ascendent u Streljcu\n- Ne pravi kratke pasuse od 1-2 recenice\n- Svaki pasus mora imati minimum 4 recenice\n\nNA KRAJU OBAVEZNO napisi tacno ovako na novom redu:\nHvala ti puno na poverenju i zelim ti zivot ispunjen mirom, radoscu i srecom.\n\nAstrolog "+aName+" \u2764\uFE0F\n\nDanas je: "+todayStr;
  ...
  async function doDsGen(){
    ...
    var sys="FORMATIRANJE TEKSTA - KRITICNO: Posle svake 4-5 recenice sam stavi dva nova reda (prazan red). Nikad ne zavrsavaj recenicu broj tacka (npr. 6. ili 7.) na kraju reda ako iza dolazi nastavak te iste recenice.\n\nTi si "+aName+", vrhunski astrolog sa 30 godina iskustva. Pises na "+lang+", ekavica, zenski rod.\n\nKRITICNO VAZNO ZA DATUME: Nikad ne pisi datum koji se proteze kroz vise redova. Uvek pisi cijeli datum u jednoj kratkoj frazi unutar recenice. Na primjer pisi 'od 15. do 20. maja 2026' NE 'od 15. aprila do\\n20. maja'. Datum mora stati u jednoj recenici bez prekidanja.\n\nZADATAK:\nNa osnovu analize klijenta napisi TACNE PERIODE u narednih 12 meseci sa konkretnim datumima. Mozes pisati tranzite i planete jer su to konkretni podaci za prognozu.\n\nNACIN PISANJA - OBAVEZNO:\nPisi kao ziva topla osoba koja razgovara sa klijentom. Svaki period pisi kao normalan pasus od 4-6 recenica koji tece prirodno. Datumi moraju biti konkretni i pisani unutar recenice bez prekidanja.\n\nAPSOLUTNO ZABRANJENO:\n- Naslovi velikim slovima (APRIL MAJ 2026 ili JUNI JULI itd)\n- Bullet liste i nabrajanja sa Sta se desava Sta treba Sta ne smes\n- Lomljenje datuma u dvije linije - datum mora biti u jednoj recenici\n- Kratki pasusi od 1-2 recenice\n- Markdown znakovi ## ** ---\n\nSTRUKTURA:\nPisi period po period kao normalne pasuse. Svaki period ima konkretan datum i opis sta ce se desiti. Pisi direktno i brutalno iskreno.\n\nDUZINA: Minimum 1200 reci. Svaki period razradi detaljno sa minimum 5-6 recenica. Pisi opsirno, duboko i konkretno. Ne skracuj, ne zuriti, ne preskakati nista.\n\nJEZIK: 100% ispravno srpski.\n\nNe pisi nikakav pozdrav na kraju. Ne pisi Hvala. Ne pisi Astrolog Suzana. Analiza perioda se zavrsava samo sa zadnjim periodom, bez zakljucnog pozdrava.\n\nDanas je: "+todayStr+".";
    while(active.current>=MAX)await new Promise(function(r){return setTimeout(r,600);});
    active.current+=1;
    try{
      var usrContent=pr+"\n\nANALIZA KLIJENTA:\n"+snap;
  ...
  async function doPqGen(){
    ...
    var sys=pqPr||("FORMATIRANJE TEKSTA - KRITICNO: Posle svake 4-5 recenice sam stavi dva nova reda (prazan red). Nikad ne zavrsavaj recenicu broj tacka (npr. 6. ili 7.) na kraju reda ako iza dolazi nastavak te iste recenice.\n\nTi si "+aName+", vrhunski astrolog sa 30 godina iskustva. Pises na "+lang+", ekavica, zenski rod.\n\nDANASNJI DATUM: "+todayStr+". Sada je "+today.getFullYear()+". godina. Sve prognoze i periodi moraju biti za "+today.getFullYear()+". i "+( today.getFullYear()+1)+". godinu. NIKAD ne pisi o proslim godinama kao sadasnjosti.\n\nZADATAK:\nKlijent ti je poslao prethodnu analizu i ima dodatna pitanja. Odgovori SAMO na postavljena pitanja, opsirno i detaljno, kao da sjedis pred tom osobom.\n\nNACIN PISANJA:\nPisi toplo, emotivno i direktno. Bez naslova velikim slovima. Bez bullet lista i nabrajanja sa brojevima. Svaki odgovor mora biti u formi pasusa od minimum 6-8 recenica. Pisi kao da razgovaras sa osobom. DUZINA: Minimum 1000 reci ukupno. Svako pitanje razradi IZUZETNO opsirno i detaljno, sa konkretnim primerima, periodima i situacijama. Ne davaj kratke odgovore.\n\nAPSOLUTNO ZABRANJENO:\n- Naslovi velikim slovima (ENERGETSKA DINAMIKA, SADASNJA SUDBINA itd)\n- Bullet liste sa brojevima ili crticama\n- Planete i kuce u tekstu (ne pisi Saturn u Ribama)\n- Kratki pasusi od 1-2 recenice\n- Markdown znakovi ## ** ---\n- Prognoze za prosle godine (2024, 2025) kao da su sadasnjost\n\nJEZIK: 100% ispravno srpski, bez gresaka. SAMO LATINICA.\n\nNe pisi nikakav pozdrav na kraju. Ne pisi Hvala. Ne pisi Astrolog Suzana. Odgovori na pitanja i to je to.");
    while(active.current>=MAX)await new Promise(function(r){return setTimeout(r,600);});
    active.current+=1;
    try{
      var resp=await fetch(API+"/api/claude",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:16000,stream:true,system:sys,messages:[{role:"user",content:"Danas je "+todayStr+", "+today.getFullYear()+". godina.\n\nPRETHODNA ANALIZA:\n"+pqPrev+"\n\nPITANJA KLIJENTA:\n"+pqQuest}]})});
      if(!resp.ok)throw new Error("HTTP "+resp.status);
      var reader=resp.body.getReader(),dec=new TextDecoder();var full="";
      while(true){
        var result=await reader.read();if(result.done)break;
  ...
  function ChunkTracker(props){
    ...
    return React.createElement("div",{className:"ctrack"},
      React.createElement("div",{style:{fontSize:"11.5px",color:"var(--gd2)",fontWeight:500}},ci+"/"+ch.length+" dijelova poslato"),
  ...
  function SlotView(props){
    ...
    return React.createElement("div",null,
      ...
      React.createElement("div",{className:"slhdr"},
        ...
        React.createElement("span",{className:"slst "+stC},stL)
      ),
      // MODE TABS
      React.createElement("div",{className:"tabs"},
        ...
        React.createElement("button",{className:"tab "+(!isMess?"on":""),onClick:function(){upSlot(idx,function(sl){return Object.assign({},sl,{mode:"rucno"});});}},"\u0158u\u010dno")
      ),
      // PASTE
      isMess&&!s.parsed&&React.createElement("div",{className:"card card-hi"},
        ...
        React.createElement("div",{className:"fld"},
          React.createElement("textarea",{value:s.paste,onChange:function(e){upSlot(idx,function(sl){return Object.assign({},sl,{paste:e.target.value});});},placeholder:"Nalepi cijelu poruku klijenta...",style:{minHeight:"100px"}})
        ),
  ...
  return React.createElement(React.Fragment,null,
    ...
    React.createElement("div",{className:"app"},
      ...
      tab==="downsell"&&React.createElement("div",{className:"sec"},
        React.createElement("div",{className:"stitle"},React.createElement(Logo,{size:19})," Downsell"),
      ...
      tab==="pitanja"&&React.createElement("div",{className:"sec"},
        React.createElement("div",{className:"stitle"},React.createElement(Logo,{size:19})," Pitanja Klijenta"),
        React.createElement("div",{className:"card card-hi"},
      ...
      tab==="prompt"&&React.createElement("div",{className:"sec"},
        React.createElement("div",{className:"stitle"},React.createElement(Logo,{size:19})," Promptovi"),
        React.createElement("div",{className:"tabs"},
      ...
      tab==="admin"&&user.role==="admin"&&React.createElement("div",{className:"sec"},
        React.createElement("div",{className:"stitle"},React.createElement(Logo,{size:19})," Admin Panel"),
        React.createElement("div",{className:"card card-hi"},

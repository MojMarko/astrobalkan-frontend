...
export default function App(){
  ...
  // MAIN ---------------------------------------------------------------------
  var navItems=[{id:"a1",l:"Analiza 1"},{id:"a2",l:"Analiza 2"},{id:"a3",l:"Analiza 3"},{id:"downsell",l:"Downsell"},{id:"baza",l:"Baza"},{id:"prompt",l:"Prompt"}];
  if(user.role==="admin")navItems.push({id:"admin",l:"Admin"});
    ...
    React.createElement("div",{className:"app"},
      ...
      React.createElement("div",{className:"hdr"},
        React.createElement("div",{className:"hdr-top"},
          React.createElement("div",{className:"hbrand"},React.createElement(Logo,{size:36}),React.createElement("div",null,React.createElement("div",{className:"hname"},"Astro Balkan"),React.createElement("div",{className:"hsub"},"Astroloski Alat"))),
        ...
        React.createElement("nav",{className:"nav"},
          navItems.map(function(n){
            ...
            return React.createElement("button",{key:n.id,className:"nav button "+(tab===n.id?"on":""),onClick:function(){setTab(n.id);}},
              n.l,isGen&&React.createElement("span",{className:"ndot"})
            );
          })
        )
      ),

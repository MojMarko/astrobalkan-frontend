...
function fmtText(text){
  ...
  // Ukloni astrolosku tehnicku notaciju ("T.Saturn" -> "Saturn", "T. Jupiter" -> "Jupiter")
  ...
  t=t.replace(/\b(Tr|Trans|Transit|Tranzit|Tranzitni)\.?\s+(?=(Sunce|Mesec|Merkur|Venera|Mars|Jupiter|Saturn|Uran|Neptun|Pluton)\b)/gi,"");
